...
const AuthForm = ({ type }: { type: string }) => {
    ...
    // below is client side function, it will be bit harded to call it from within here, we cannot use top level await
    // try to call it in signup page
                            ...
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                                {
                                    type === 'sign-up' && (
                                        <>
                                            ...
                                            <div className="flex gap-4">
                                                <CustomInput control={form.control} name="dob" label="Date Of Birth" placeholder="Enter your date of birth" />
