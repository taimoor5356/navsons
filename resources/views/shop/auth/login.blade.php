...
<head>
    ...
    <!-- App title -->
    <title>{{ $generaleSetting?->title ?? config('app.name', 'Navsons') }} Shop Login</title>
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no, shrink-to-fit=no" />
    <meta name="description"
        content="{{ $generaleSetting?->name ?? config('app.name', 'Navsons') }} shop pannel login">
                ...
                @if (app()->isLocal())
                    <div class="d-flex justify-content-between align-items-center gap-2">
                        <span class="powerBy">Powered by <a class="text-primary text-decoration-none fw-bold"
                                href="https://navsons.com/" target="_blank">Navsons</a>
                            ©{{ date('Y') }}</span>
