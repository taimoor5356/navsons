...
@section('header-title', __('Add New Category Banner'))

@section('content')
    <div class="page-title">
        <div class="d-flex gap-2 align-items-center">
            <i class="fa-solid fa-image"></i> {{ __('Add New Category Banner') }}
        </div>
    </div>
    <form action="{{ route('admin.categoryBanner.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            ...
                            <select name="position" id="position" class="form-select @error('position') is-invalid @enderror" required>
                                <option value="top" selected>{{ __('Top') }}</option>
