...
if (env('APP_STATUS') == 'testingss' || env('APP_STATUS') == 'development' || env('APP_STATUS') == 'production' || env('APP_STATUS') == 'live') {
    Route::prefix('')->group(function () {
        Route::get('/', [WebController::class, 'index'])->name('home');
        Route::get('/temp-products', [WebController::class, 'tempProducts'])->name('temp.products');
        Route::post('/update-temp-product-status', [WebController::class, 'updateTempProductStatus'])->name('update.temp.product.status');
